...
public class DataSeeder implements CommandLineRunner {
    ...
    @Value("${aws.s3.bucket:herculix-media-prod}")
    ...
    private List<User> seedUsers() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            String email = ("user" + (i + 1) + "@herculix.com").toLowerCase();
    ...
    private List<Trainer> seedTrainers() {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            String email = ("trainer" + (i + 1) + "@herculix.com").toLowerCase();
