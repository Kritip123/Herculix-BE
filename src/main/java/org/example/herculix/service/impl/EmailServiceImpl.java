...
import org.example.herculix.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendWelcomeEmail(String email, String name) {
        ...
        try {
            ...
            helper.setTo(email);
            helper.setSubject("Welcome to Herculix!");
            
            String htmlContent = String.format("""
                <html>
                <body style="font-family: Arial, sans-serif; color: #333;">
                    <h2>Welcome to Herculix, %s!</h2>
                    ...
                    <br>
                    <p>Best regards,<br>The Herculix Team</p>
                </body>
                </html>
                """, name, supportEmail);
    ...
    public void sendPasswordResetEmail(String email, String name, String resetToken) {
        ...
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(email);
            helper.setSubject("Password Reset Request - Herculix");
            
            String resetLink = "https://herculix.com.au/reset-password?token=" + resetToken;
    ...
    public void sendPasswordChangedEmail(String email, String name) {
        ...
        message.setTo(email);
        message.setSubject("Password Changed Successfully - Herculix");
