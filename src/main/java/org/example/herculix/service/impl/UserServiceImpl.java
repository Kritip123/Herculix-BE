...
import org.example.herculix.entity.SavedTrainer;
import org.example.herculix.entity.Trainer;
import org.example.herculix.repository.SavedTrainerRepository;
import org.example.herculix.repository.SkippedTrainerRepository;
...
import org.example.herculix.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public SavedTrainerResponse saveTrainer(String userId, SavedTrainerRequest request) {
        ...
        var saved = savedTrainerRepository.save(org.example.herculix.entity.SavedTrainer.builder()
                .userId(user.getId())
    ...
    public void skipTrainer(String userId, SkippedTrainerRequest request) {
        ...
        skippedTrainerRepository.save(org.example.herculix.entity.SkippedTrainer.builder()
                .userId(user.getId())
                .trainerId(request.getTrainerId())
                .build());
    }
