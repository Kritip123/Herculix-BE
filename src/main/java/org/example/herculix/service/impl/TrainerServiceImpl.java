...
import org.example.herculix.mapper.TrainerMapper;
import org.example.herculix.model.dto.ReviewDTO;
import org.example.herculix.model.dto.TrainerDTO;
import org.example.herculix.model.request.TrainerSearchRequest;
import org.example.herculix.model.request.TrainerMatchRequest;
import org.example.herculix.model.response.MatchedTrainerResponse;
import org.example.herculix.model.response.PageResponse;
import org.example.herculix.model.response.TrainerPortfolioResponse;
import org.example.herculix.repository.ReviewRepository;
import org.example.herculix.repository.UserRepository;
import org.example.herculix.repository.TrainerAvailabilityRepository;
import org.example.herculix.repository.TrainerRepository;
import org.example.herculix.service.TrainerService;
import org.example.herculix.service.TrainerVisibilityService;
import org.example.herculix.util.DistanceCalculator;
...
public class TrainerServiceImpl implements TrainerService {
    ...
    private MatchedTrainerResponse buildMatch(Trainer trainer, TrainerMatchRequest request) {
        ...
        if (request.getTrainerGender() != null) {
            if (request.getTrainerGender() == org.example.herculix.entity.User.TrainerGenderPreference.NO_PREFERENCE) {
                score += 10;
            } else if (trainer.getGender() != null) {
                boolean matches = (request.getTrainerGender() == org.example.herculix.entity.User.TrainerGenderPreference.MALE
                        && trainer.getGender() == org.example.herculix.entity.User.Gender.MALE)
                        || (request.getTrainerGender() == org.example.herculix.entity.User.TrainerGenderPreference.FEMALE
                        && trainer.getGender() == org.example.herculix.entity.User.Gender.FEMALE);
                if (matches) {
                    score += 10;
                }
            }
